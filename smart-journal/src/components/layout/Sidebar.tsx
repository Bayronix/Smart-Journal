...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-60 min-h-screen bg-white dark:bg-zinc-950 border-r border-slate-200 dark:border-zinc-800 px-3 py-6 gap-6 shrink-0 transition-colors duration-200">
      {/* Logo */}
      <div className="px-3 flex items-center gap-2.5">
        <div className="w-7 h-7 rounded-lg bg-indigo-600 flex items-center justify-center">
          <BookOpen size={14} className="text-white" />
        </div>
        <span className="font-semibold text-slate-900 dark:text-zinc-100 text-sm tracking-wide">Smart Journal</span>
      </div>
